		...
		consumer.accept(ESLootTables.CHEST_GOLEM_FORGE,
			LootTable.lootTable()
				.withPool(LootPool.lootPool()
					...
					.add(LootItem.lootTableItem(ESItems.DEEPSILVER_INGOT.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 3))).setWeight(25))
				...
				.withPool(LootPool.lootPool()
					...
					.add(LootItem.lootTableItem(ESItems.DEEPSILVER_NUGGET.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 5))).setWeight(45))
		...
		consumer.accept(ESLootTables.CHEST_CURSED_GARDEN,
			LootTable.lootTable()
				...
				.withPool(LootPool.lootPool()
					...
					.add(LootItem.lootTableItem(ESItems.DEEPSILVER_NUGGET.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 9))).setWeight(45))
