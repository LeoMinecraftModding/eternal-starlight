...
public class ESSoundProvider extends SoundDefinitionsProvider {
	...
	public void registerSounds() {
		add(ESSoundEvents.MUSIC_DIMENSION.get(), definition().with(sound(loc("music/dimension/tranquility")).stream(), sound(loc("music/dimension/whisper_of_the_stars")).stream(), sound(loc("music/dimension/dusk_o_ereyesterday")).stream(), sound(loc("music/dimension/nest_ii")).stream()));
		add(ESSoundEvents.MUSIC_BIOME_STARLIGHT_FOREST.get(), definition().with(sound(loc("music/dimension/tranquility")).stream(), sound(loc("music/dimension/whisper_of_the_stars")).stream(), sound(loc("music/dimension/dusk_o_ereyesterday")).stream(), sound(loc("music/dimension/nest_ii")).stream()));
		...
		add(ESSoundEvents.MUSIC_BIOME_SCARLET_FOREST.get(), definition().with(sound(loc("music/biome/deep_blue")).weight(5).stream(), sound(loc("music/dimension/tranquility")).stream(), sound(loc("music/dimension/whisper_of_the_stars")).stream(), sound(loc("music/dimension/dusk_o_ereyesterday")).stream(), sound(loc("music/dimension/nest_ii")).stream()));
		...
		add(ESSoundEvents.MUSIC_BIOME_STARLIT_SEA.get(), definition().with(sound(loc("music/biome/stars_shining_upon_the_sea")).weight(5).stream(), sound(loc("music/dimension/whisper_of_the_stars")).stream(), sound(loc("music/dimension/dusk_o_ereyesterday")).stream(), sound(loc("music/dimension/nest_ii")).stream()));
		add(ESSoundEvents.MUSIC_BIOME_SPIRAL_KELP_FOREST.get(), definition().with(sound(loc("music/biome/the_dark_side")).weight(5).stream(), sound(loc("music/dimension/whisper_of_the_stars")).stream(), sound(loc("music/dimension/dusk_o_ereyesterday")).stream(), sound(loc("music/dimension/nest_ii")).stream()));
		add(ESSoundEvents.MUSIC_BIOME_LUSH_SHALLOW_SEA.get(), definition().with(sound(loc("music/biome/viridescent")).weight(5).stream(), sound(loc("music/dimension/whisper_of_the_stars")).stream(), sound(loc("music/dimension/dusk_o_ereyesterday")).stream(), sound(loc("music/dimension/nest_ii")).stream()));
		add(ESSoundEvents.MUSIC_BIOME_THE_ABYSS.get(), definition().with(sound(loc("music/biome/profundity")).weight(5).stream(), sound(loc("music/dimension/whisper_of_the_stars")).stream(), sound(loc("music/dimension/dusk_o_ereyesterday")).stream(), sound(loc("music/dimension/nest_ii")).stream()));
		...
		add(ESSoundEvents.MUSIC_DISC_NEST_II.get(), definition().with(sound(loc("music/dimension/nest_ii")).stream()));
		...
		add(ESSoundEvents.MUSIC_DISC_DEEP_BLUE.get(), definition().with(sound(loc("music/biome/deep_blue")).stream()));
		add(ESSoundEvents.MUSIC_DISC_THE_DARK_SIDE.get(), definition().with(sound(loc("music/biome/the_dark_side")).stream()));
		add(ESSoundEvents.MUSIC_DISC_VIRIDESCENT.get(), definition().with(sound(loc("music/biome/viridescent")).stream()));
		...
		add(ESSoundEvents.MUSIC_DISC_NEST.get(), definition().with(sound(loc("music/disc/nest")).stream()));
