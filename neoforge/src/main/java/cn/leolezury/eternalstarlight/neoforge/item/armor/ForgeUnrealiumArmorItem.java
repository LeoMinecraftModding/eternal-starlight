...
public class ForgeUnrealiumArmorItem extends UnrealiumArmorItem {
	public ForgeUnrealiumArmorItem(Holder<ArmorMaterial> material, Type type, Properties properties) {
