...
public class ESNeoDimensionSpecialEffects extends ESDimensionSpecialEffects {
	public ESNeoDimensionSpecialEffects(float cloudHeight, boolean placebo, SkyType fogType, boolean brightenLightMap, boolean entityLightingBottomsLit) {
