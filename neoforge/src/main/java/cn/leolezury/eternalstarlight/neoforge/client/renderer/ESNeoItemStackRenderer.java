...
public class ESNeoItemStackRenderer extends BlockEntityWithoutLevelRenderer {
	public static final Supplier<ESNeoItemStackRenderer> INSTANCE = Suppliers.memoize(ESNeoItemStackRenderer::new);
