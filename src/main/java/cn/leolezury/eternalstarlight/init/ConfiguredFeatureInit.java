...
import cn.leolezury.eternalstarlight.world.feature.tree.LeafSpheroidFoliagePlacer;
...
public class ConfiguredFeatureInit {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, LUNAR_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(BlockInit.LUNAR_LOG.get()), new BranchingTrunkPlacer(7, 2, 5), BlockStateProvider.simple(BlockInit.LUNAR_LEAVES.get()), new LeafSpheroidFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)), new TwoLayersFeatureSize(4, 1, 1)).decorators(List.of(new TrunkBerriesDecorator())).build());
