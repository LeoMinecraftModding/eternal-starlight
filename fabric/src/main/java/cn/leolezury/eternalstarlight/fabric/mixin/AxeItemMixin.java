...
public abstract class AxeItemMixin {
	...
	private Optional<BlockState> evaluateNewBlockState(AxeItem instance, Level level, BlockPos pos, Player player, BlockState state, Operation<Optional<BlockState>> original, @Local(argsOnly = true) UseOnContext context) {
