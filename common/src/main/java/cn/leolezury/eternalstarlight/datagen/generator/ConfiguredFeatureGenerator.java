...
public class ConfiguredFeatureGenerator {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> SWAMP_GRASS_KEY = registerKey("swamp_grass");
    public static final ResourceKey<ConfiguredFeature<?, ?>> SWAMP_LAKE_KEY = registerKey("swamp_lake");
    public static final ResourceKey<ConfiguredFeature<?, ?>> SWAMP_WATER_KEY = registerKey("swamp_water");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, SL_PERMAFROST_FOREST_KEY, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureGenerator.NORTHLAND_TREE_CHECKED_KEY), 0.25F), new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureGenerator.NORTHLAND_ON_SNOW_KEY), 0.25F)), placedFeatureHolderGetter.getOrThrow(TreePlacements.OAK_CHECKED)));
        ...
        register(context, SWAMP_LAKE_KEY, FeatureInit.SL_LAKE.get(), new BetterLakeFeature.Configuration(BlockStateProvider.simple(Blocks.WATER.defaultBlockState()), swampLakeStateProvider, UniformInt.of(8, 10), UniformInt.of(4, 6), UniformInt.of(8, 10)));
        register(context, SWAMP_WATER_KEY, FeatureInit.SWAMP_WATER.get(), new NoneFeatureConfiguration());
        ...
        register(context, CAVE_SPRING_KEY, FeatureInit.SL_LAKE.get(), new BetterLakeFeature.Configuration(BlockStateProvider.simple(Blocks.WATER.defaultBlockState()), caveSpringStateProvider, UniformInt.of(8, 10), UniformInt.of(6, 8), UniformInt.of(8, 10)));
