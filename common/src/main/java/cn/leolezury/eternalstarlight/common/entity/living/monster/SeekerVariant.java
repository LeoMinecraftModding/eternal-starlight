...
public record SeekerVariant(ResourceLocation texture, ResourceLocation textureFull, ResourceLocation glowTexture, ResourceLocation glowTextureFull, ResourceLocation tentacleTexture, ResourceLocation tentacleTextureFull, HolderSet<Biome> biomes) {
	...
	public SeekerVariant(ResourceLocation texture, ResourceLocation glowTexture, ResourceLocation tentacleTexture, HolderSet<Biome> biomes) {
		this(texture, fullTextureId(texture), glowTexture, fullTextureId(glowTexture), tentacleTexture, fullTextureId(tentacleTexture), biomes);
	}
