...
public class ESSpells {
	...
	public static final RegistryObject<AbstractSpell, FlamingAftershockSpell> FLAMING_AFTERSHOCK = SPELLS.register("flaming_aftershock", () -> new FlamingAftershockSpell(new AbstractSpell.Properties(List.of(ManaType.BLAZE, ManaType.TERRA), 30, 400, 250)));
	public static final RegistryObject<AbstractSpell, FlamingRingSpell> FLAMING_RING = SPELLS.register("flaming_ring", () -> new FlamingRingSpell(new AbstractSpell.Properties(List.of(ManaType.BLAZE, ManaType.LIGHT), 30, 400, 250)));
	public static final RegistryObject<AbstractSpell, FlamingArcSpell> FLAMING_ARC = SPELLS.register("flaming_arc", () -> new FlamingArcSpell(new AbstractSpell.Properties(List.of(ManaType.BLAZE, ManaType.LIGHT), 30, 400, 250)));
	...
	public static final RegistryObject<AbstractSpell, SurroundingFireballsSpell> SURROUNDING_FIREBALLS = SPELLS.register("surrounding_fireballs", () -> new SurroundingFireballsSpell(new AbstractSpell.Properties(List.of(ManaType.BLAZE, ManaType.LIGHT), 30, 400, 250)));
