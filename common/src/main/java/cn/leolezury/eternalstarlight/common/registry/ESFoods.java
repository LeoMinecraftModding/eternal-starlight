...
public class ESFoods {
	...
	public static final Supplier<FoodProperties> ROASTED_FORGOTTEN_NOCTURNAL_MILLET = Suppliers.memoize(() -> new FoodProperties.Builder().nutrition(10).saturationModifier(0.8F).effect(new MobEffectInstance(ESMobEffects.OBLIVION.asHolder(), 600, 0), 1f).alwaysEdible().build());
