...
public class ESEntities {
	...
	public static final RegistryObject<EntityType<?>, EntityType<CrystallizedMoth>> CRYSTALLIZED_MOTH = ENTITIES.register("crystallized_moth", () -> EntityType.Builder.of(CrystallizedMoth::new, MobCategory.AMBIENT).sized(0.5F, 0.5F).clientTrackingRange(8).build(EternalStarlight.id("crystallized_moth").toString()));
	public static final RegistryObject<EntityType<?>, EntityType<ShimmerLacewing>> SHIMMER_LACEWING = ENTITIES.register("shimmer_lacewing", () -> EntityType.Builder.of(ShimmerLacewing::new, MobCategory.AMBIENT).sized(0.5F, 0.5F).clientTrackingRange(8).build(EternalStarlight.id("shimmer_lacewing").toString()));
