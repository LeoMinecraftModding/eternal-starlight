...
public class ESSmokeParticle extends SimpleAnimatedParticle {
    ...
    protected ESSmokeParticle(ClientLevel clientLevel, float lifeMultiplier, double x, double y, double z, double dx, double dy, double dz, double movementMultiplier, int fromColor, int toColor, SpriteSet spriteSet, float gravity) {
    ...
    public static class FlameProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double dx, double dy, double dz) {
            return new ESSmokeParticle(clientLevel, 1f, x, y, z, dx, dy, dz, 1f, 0xff9319, 0x310a02, this.sprites, 0);
        }
    }
    ...
    public static class EnergizedFlameProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double dx, double dy, double dz) {
            return new ESSmokeParticle(clientLevel, 1.2f, x, y, z, dx, dy, dz, 1.8f, 0xcfffff, 0x310a02, this.sprites, 0);
        }
    }
}
