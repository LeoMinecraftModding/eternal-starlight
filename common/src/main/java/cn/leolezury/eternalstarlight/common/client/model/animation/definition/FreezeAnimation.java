...
public class FreezeAnimation {
    ...
    public static final AnimationDefinition IDLE_AGGRESSIVE = AnimationDefinition.Builder.withLength(2.0F).looping()
            .addAnimation("rods", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.0F, KeyframeAnimations.degreeVec(0.0F, 360.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
            ))
    ...
    public static final AnimationDefinition THROW = AnimationDefinition.Builder.withLength(1.0F)
            .addAnimation("rod1", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
