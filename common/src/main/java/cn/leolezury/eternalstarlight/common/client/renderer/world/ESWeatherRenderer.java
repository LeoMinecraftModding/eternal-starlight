...
public class ESWeatherRenderer {
    ...
    public static void renderWeatherWithRotation(LightTexture lightTexture, Biome.Precipitation weatherType, ResourceLocation rainLocation, ResourceLocation snowLocation, float rainLevel, int ticks, boolean fullBright, float partialTicks, double camX, double camY, double camZ, float rotX, float rotY, float rotZ) {
        initialize();
        Minecraft minecraft = Minecraft.getInstance();
        if (!(rainLevel <= 0.0F)) {
            lightTexture.turnOnLightLayer();
                    ...
                    if (biome.hasPrecipitation()) {
                        ...
                        if (u != v) {
                            ...
                            if (precipitation == Biome.Precipitation.RAIN) {
                                ...
                                mutableBlockPos.set(p, w, o);
                                ag = fullBright ? 0xF000F0 : LevelRenderer.getLightColor(level, mutableBlockPos);
                                bufferBuilder.vertex((double)p - camX - r + 0.5 - rotX, (double)v - camY - rotY, (double)o - camZ - rotZ - s + 0.5).uv(0.0F, (float)u * 0.25F + ab).color(1.0F, 1.0F, 1.0F, af).uv2(ag).endVertex();
                                bufferBuilder.vertex((double)p - camX + r + 0.5, (double)v - camY, (double)o - camZ + s + 0.5).uv(1.0F, (float)u * 0.25F + ab).color(1.0F, 1.0F, 1.0F, af).uv2(ag).endVertex();
                                bufferBuilder.vertex((double)p - camX + r + 0.5 - rotX, (double)u - camY - rotY, (double)o - camZ - rotZ + s + 0.5).uv(1.0F, (float)v * 0.25F + ab).color(1.0F, 1.0F, 1.0F, af).uv2(ag).endVertex();
                                bufferBuilder.vertex((double)p - camX - r + 0.5, (double)u - camY, (double)o - camZ - s + 0.5).uv(0.0F, (float)v * 0.25F + ab).color(1.0F, 1.0F, 1.0F, af).uv2(ag).endVertex();
                            } else if (precipitation == Biome.Precipitation.SNOW) {
                                if (m != 1) {
                                    if (m >= 0) {
                                ...
                                int ap = (ag * 3 + 240) / 4;
                                bufferBuilder.vertex((double)p - camX - r + 0.5, (double)v - camY, (double)o - camZ - s + 0.5).uv(0.0F + ai, (float)u * 0.25F + ah + z).color(1.0F, 1.0F, 1.0F, al).uv2(ap, ao).endVertex();
                                bufferBuilder.vertex((double)p - camX + r - rotX + 0.5, (double)v - camY - rotY, (double)o - camZ - rotZ + s + 0.5).uv(1.0F + ai, (float)u * 0.25F + ah + z).color(1.0F, 1.0F, 1.0F, al).uv2(ap, ao).endVertex();
                                bufferBuilder.vertex((double)p - camX + r + 0.5, (double)u - camY, (double)o - camZ + s + 0.5).uv(1.0F + ai, (float)v * 0.25F + ah + z).color(1.0F, 1.0F, 1.0F, al).uv2(ap, ao).endVertex();
                                bufferBuilder.vertex((double)p - camX - r - rotX + 0.5, (double)u - camY - rotY, (double)o - camZ - rotZ - s + 0.5).uv(0.0F + ai, (float)v * 0.25F + ah + z).color(1.0F, 1.0F, 1.0F, al).uv2(ap, ao).endVertex();
                            }
                        }
                    }
                }
