...
public class ESEnchantments {
	...
	public static void bootstrap(BootstrapContext<Enchantment> context) {
		...
		context.register(OVERHEAT, Enchantment.enchantment(Enchantment.definition(items.getOrThrow(ESTags.Items.SEEDS_LAUNCHER_ENCHANTABLE), items.getOrThrow(ESTags.Items.SEEDS_LAUNCHER_ENCHANTABLE), 5, 2, Enchantment.dynamicCost(20, 11), Enchantment.dynamicCost(30, 11), 4, EquipmentSlotGroup.MAINHAND))
		...
		context.register(GLACIAL_SOWING, Enchantment.enchantment(Enchantment.definition(items.getOrThrow(ESTags.Items.SEEDS_LAUNCHER_ENCHANTABLE), items.getOrThrow(ESTags.Items.SEEDS_LAUNCHER_ENCHANTABLE), 5, 2, Enchantment.dynamicCost(20, 11), Enchantment.dynamicCost(30, 11), 4, EquipmentSlotGroup.MAINHAND))
