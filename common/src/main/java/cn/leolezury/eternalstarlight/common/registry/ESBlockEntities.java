...
public class ESBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<?>, BlockEntityType<TreeRootBlockEntity>> TREE_ROOT = BLOCK_ENTITIES.register("tree_root", () -> BlockEntityType.Builder.of(
