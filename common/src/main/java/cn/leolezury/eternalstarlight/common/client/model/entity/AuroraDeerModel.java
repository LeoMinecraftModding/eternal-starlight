...
import cn.leolezury.eternalstarlight.common.entity.animal.AuroraDeer;
...
public class AuroraDeerModel<T extends AuroraDeer> extends AnimatedEntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(EternalStarlight.MOD_ID, "aurora_deer"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(4, 0).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.153F, 9.3675F, -0.5672F, 0.0F, 0.0F));

        PartDefinition neck = body.addOrReplaceChild("neck", CubeListBuilder.create(), PartPose.offset(0.0F, -7.153F, -8.6325F));

        PartDefinition cube_r2 = neck.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(26, 30).addBox(-2.0F, -0.9F, -2.2F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.5F, 0.0F, 0.0873F, 0.0F, 0.0F));
        ...
        PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(10, 1).addBox(-5.5F, -1.5F, -0.4F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -5.5F, 2.0F, 0.0F, -0.3491F, 0.0F));
        ...
        PartDefinition right_front_leg = root.addOrReplaceChild("right_front_leg", CubeListBuilder.create().texOffs(34, 38).addBox(-1.5F, -1.0F, -2.25F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(45, 44).addBox(-1.5F, 4.0F, -1.25F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.5F, -9.0F, -7.65F));

        PartDefinition left_rear_leg = root.addOrReplaceChild("left_rear_leg", CubeListBuilder.create().texOffs(36, 9).addBox(-1.5F, -1.0F, -2.25F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(0, 41).addBox(-1.5F, 4.0F, -1.25F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, -9.0F, 8.15F));

        PartDefinition right_rear_leg = root.addOrReplaceChild("right_rear_leg", CubeListBuilder.create().texOffs(42, 27).addBox(-1.5F, 4.0F, -1.25F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
