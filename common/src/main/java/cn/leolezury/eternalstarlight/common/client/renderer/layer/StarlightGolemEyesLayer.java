...
public class StarlightGolemEyesLayer<T extends StarlightGolem, M extends StarlightGolemModel<T>> extends EyesLayer<T, M> {
    private static final RenderType EYES = RenderType.eyes(new ResourceLocation(EternalStarlight.MOD_ID, "textures/entity/starlight_golem/starlight_golem_eyes.png"));
    private static final RenderType EYES_HALLOWEEN = RenderType.eyes(new ResourceLocation(EternalStarlight.MOD_ID, "textures/entity/starlight_golem/starlight_golem_eyes_halloween.png"));
