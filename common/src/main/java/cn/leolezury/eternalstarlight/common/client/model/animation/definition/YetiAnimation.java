...
public class YetiAnimation {
	...
	public static final AnimationDefinition ROLL_START = AnimationDefinition.Builder.withLength(0.5F)
		.addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition ROLL = AnimationDefinition.Builder.withLength(0.5F)
		.addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
	...
	public static final AnimationDefinition ROLL_END = AnimationDefinition.Builder.withLength(0.5F)
		.addAnimation("left_leg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
