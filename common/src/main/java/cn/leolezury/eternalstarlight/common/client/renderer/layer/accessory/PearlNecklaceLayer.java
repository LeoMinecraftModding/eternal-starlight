...
public class PearlNecklaceLayer extends ArmorLikeAccessoryLayer<LivingEntity, HumanoidModel<LivingEntity>, HumanoidModel<LivingEntity>> {
	private static final ResourceLocation TEXTURE = EternalStarlight.id("textures/accessory/pearl_necklace.png");

	public PearlNecklaceLayer(RenderLayerParent<LivingEntity, HumanoidModel<LivingEntity>> renderer, HumanoidModel<LivingEntity> innerModel, HumanoidModel<LivingEntity> outerModel) {
