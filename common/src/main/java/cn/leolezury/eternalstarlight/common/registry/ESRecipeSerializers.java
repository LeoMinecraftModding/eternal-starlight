...
public class ESRecipeSerializers {
	...
	public static final RegistryObject<RecipeSerializer<?>, RecipeSerializer<EtherConversionRecipe>> ETHER_CONVERSION = RECIPE_SERIALIZERS.register("ether_conversion", EtherConversionRecipe.Serializer::new);
