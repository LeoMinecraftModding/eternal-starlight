...
public abstract class AbstractESBoss extends Monster {
    protected AbstractESBoss(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    ...
    protected static final EntityDataAccessor<Integer> PHASE = SynchedEntityData.defineId(AbstractESBoss.class, EntityDataSerializers.INT);
    public int getPhase() {
    ...
    protected static final EntityDataAccessor<Integer> ATTACK_STATE = SynchedEntityData.defineId(AbstractESBoss.class, EntityDataSerializers.INT);
    ...
    protected static final EntityDataAccessor<Integer> ATTACK_TICKS = SynchedEntityData.defineId(AbstractESBoss.class, EntityDataSerializers.INT);
    ...
    protected static final EntityDataAccessor<Boolean> ACTIVATED = SynchedEntityData.defineId(AbstractESBoss.class, EntityDataSerializers.BOOLEAN);
