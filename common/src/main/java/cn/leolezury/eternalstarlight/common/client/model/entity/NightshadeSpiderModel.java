...
public class NightshadeSpiderModel<T extends NightshadeSpider> extends HierarchicalModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(EternalStarlight.MOD_ID, "nightshade_spider"), "main");
    ...
    public NightshadeSpiderModel(ModelPart root) {
        this.root = root;
