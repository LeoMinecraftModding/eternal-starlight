...
public class ESArmorMaterials {
	...
	public static final RegistryObject<ArmorMaterial, ArmorMaterial> AMARAMBER = ARMOR_MATERIALS.register("amaramber", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), (map) -> {
		...
		map.put(ArmorItem.Type.HELMET, 2);
	}), 9, ESSoundEvents.ARMOR_EQUIP_AMARAMBER.asHolder(), () -> Ingredient.of(ESItems.AMARAMBER_INGOT.get()), List.of(new ArmorMaterial.Layer(EternalStarlight.id("amaramber"))), 0F, 0F));
	public static final RegistryObject<ArmorMaterial, ArmorMaterial> AETHERSENT = ARMOR_MATERIALS.register("aethersent", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), (map) -> {
		...
		map.put(ArmorItem.Type.CHESTPLATE, 5);
		map.put(ArmorItem.Type.HELMET, 2);
	}), 35, ESSoundEvents.ARMOR_EQUIP_AETHERSENT.asHolder(), () -> Ingredient.of(ESItems.AETHERSENT_INGOT.get()), List.of(new ArmorMaterial.Layer(EternalStarlight.id("aethersent"))), 0F, 0F));
	...
	}), 15, ESSoundEvents.ARMOR_EQUIP_THERMAL_SPRINGSTONE.asHolder(), () -> Ingredient.of(ESItems.THERMAL_SPRINGSTONE_INGOT.get()), List.of(new ArmorMaterial.Layer(EternalStarlight.id("thermal_springstone"))), 0.5F, 0F));
	public static final RegistryObject<ArmorMaterial, ArmorMaterial> GLACITE = ARMOR_MATERIALS.register("glacite", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), (map) -> {
		...
		map.put(ArmorItem.Type.CHESTPLATE, 6);
		map.put(ArmorItem.Type.HELMET, 3);
	}), 9, ESSoundEvents.ARMOR_EQUIP_GLACITE.asHolder(), () -> Ingredient.of(ESItems.GLACITE_SHARD.get()), List.of(new ArmorMaterial.Layer(EternalStarlight.id("glacite"))), 0.5F, 0F));
	public static final RegistryObject<ArmorMaterial, ArmorMaterial> SWAMP_SILVER = ARMOR_MATERIALS.register("swamp_silver", () -> new ArmorMaterial(Util.make(new EnumMap<>(ArmorItem.Type.class), (map) -> {
		...
		map.put(ArmorItem.Type.CHESTPLATE, 6);
		map.put(ArmorItem.Type.HELMET, 2);
	}), 25, ESSoundEvents.ARMOR_EQUIP_SWAMP_SILVER.asHolder(), () -> Ingredient.of(ESItems.SWAMP_SILVER_INGOT.get()), List.of(new ArmorMaterial.Layer(EternalStarlight.id("swamp_silver"))), 0.5F, 0.2F));
