...
import cn.leolezury.eternalstarlight.common.world.feature.BetterLakeFeature;
import cn.leolezury.eternalstarlight.common.world.feature.FallenLogFeature;
import cn.leolezury.eternalstarlight.common.world.feature.HugeTreeFeature;
import cn.leolezury.eternalstarlight.common.world.feature.tree.BranchingTrunkPlacer;
import cn.leolezury.eternalstarlight.common.world.feature.tree.SpheroidFoliagePlacer;
import cn.leolezury.eternalstarlight.common.world.feature.tree.TrunkBerriesDecorator;
...
public class ConfiguredFeatureInit {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> LUNAR_HUGE_TREE = registerKey("lunar_huge_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> NORTHLAND_HUGE_TREE = registerKey("northland_huge_tree");
    public static final ResourceKey<ConfiguredFeature<?, ?>> STARLIGHT_MANGROVE_HUGE_TREE = registerKey("starlight_mangrove_huge_tree");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, LUNAR_HUGE_TREE, FeatureInit.HUGE_TREE.get(), new HugeTreeFeature.Configuration(BlockStateProvider.simple(BlockInit.LUNAR_LOG.get()), BlockStateProvider.simple(BlockInit.LUNAR_LEAVES.get()), UniformInt.of(20, 40), UniformInt.of(6, 8), UniformInt.of(2, 3)));
        register(context, NORTHLAND_HUGE_TREE, FeatureInit.HUGE_TREE.get(), new HugeTreeFeature.Configuration(BlockStateProvider.simple(BlockInit.NORTHLAND_LOG.get()), BlockStateProvider.simple(BlockInit.NORTHLAND_LEAVES.get()), UniformInt.of(20, 40), UniformInt.of(6, 8), UniformInt.of(2, 3)));
        register(context, STARLIGHT_MANGROVE_HUGE_TREE, FeatureInit.HUGE_TREE.get(), new HugeTreeFeature.Configuration(BlockStateProvider.simple(BlockInit.STARLIGHT_MANGROVE_LOG.get()), BlockStateProvider.simple(BlockInit.STARLIGHT_MANGROVE_LEAVES.get()), UniformInt.of(20, 40), UniformInt.of(6, 8), UniformInt.of(2, 3)));
        ...
        register(context, SL_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.HUGE_GLOWING_MUSHROOM_CHECKED), 0.175F), new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.LUNAR_TREE_CHECKED), 0.825F)), placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.LUNAR_TREE_CHECKED)));
        register(context, SL_DENSE_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.LUNAR_TREE_CHECKED), 0.9F), new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.HUGE_GLOWING_MUSHROOM_CHECKED), 0.1F)), placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.LUNAR_TREE_CHECKED)));
        register(context, SL_SWAMP_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.STARLIGHT_MANGROVE_TREE_CHECKED), 0.9F), new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.HUGE_GLOWING_MUSHROOM_CHECKED), 0.1F)), placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.STARLIGHT_MANGROVE_TREE_CHECKED)));
        register(context, SL_PERMAFROST_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.NORTHLAND_TREE_CHECKED), 0.25F), new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.NORTHLAND_ON_SNOW), 0.25F)), placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.NORTHLAND_TREE_CHECKED)));
        ...
        register(context, SWAMP_LAKE, FeatureInit.BETTER_LAKE.get(), new BetterLakeFeature.Configuration(BlockStateProvider.simple(Blocks.WATER.defaultBlockState()), swampLakeStateProvider, UniformInt.of(8, 10), UniformInt.of(4, 6), UniformInt.of(8, 10)));
        ...
        register(context, CAVE_SPRING, FeatureInit.BETTER_LAKE.get(), new BetterLakeFeature.Configuration(BlockStateProvider.simple(Blocks.WATER.defaultBlockState()), caveSpringStateProvider, UniformInt.of(8, 10), UniformInt.of(6, 8), UniformInt.of(8, 10)));
