...
public class ConfiguredFeatureInit {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, GRIMSTONE_REDSTONE_ORE, Feature.ORE, new OreConfiguration(grimstoneRule, BlockInit.GRIMSTONE_REDSTONE_ORE.get().defaultBlockState(), 7));
        register(context, VOIDSTONE_REDSTONE_ORE, Feature.ORE, new OreConfiguration(voidstoneRule, BlockInit.VOIDSTONE_REDSTONE_ORE.get().defaultBlockState(), 7));
        register(context, GRIMSTONE_SALTPETER_ORE, Feature.ORE, new OreConfiguration(grimstoneRule, BlockInit.GRIMSTONE_SALTPETER_ORE.get().defaultBlockState(), 20));
        register(context, VOIDSTONE_SALTPETER_ORE, Feature.ORE, new OreConfiguration(voidstoneRule, BlockInit.VOIDSTONE_SALTPETER_ORE.get().defaultBlockState(), 20));
        ...
        register(context, CAVE_MOSS, Feature.BLOCK_COLUMN, new BlockColumnConfiguration(List.of(BlockColumnConfiguration.layer(new WeightedListInt(SimpleWeightedRandomList.<IntProvider>builder().add(UniformInt.of(10, 14), 1).add(UniformInt.of(6, 10), 2).add(UniformInt.of(0, 6), 6).build()),
                BlockStateProvider.simple(BlockInit.CAVE_MOSS_PLANT.get())), BlockColumnConfiguration.layer(ConstantInt.of(1),
                new RandomizedIntStateProvider(BlockStateProvider.simple(BlockInit.CAVE_MOSS.get()), CaveMossBlock.AGE, UniformInt.of(23, 25)))), Direction.DOWN, BlockPredicate.ONLY_IN_AIR_PREDICATE, true));
        ...
        register(context, THERMABYSSLATE_PATCH, FeatureInit.ABYSSLATE_PATCH.get(), new AbysslatePatchFeature.Configuration(BlockStateProvider.simple(BlockInit.THERMABYSSLATE.get()), BlockStateProvider.simple(BlockInit.THERMABYSSAL_MAGMA_BLOCK.get()), BlockStateProvider.simple(BlockInit.THERMABYSSAL_GEYSER.get())));
        register(context, CRYOBYSSLATE_PATCH, FeatureInit.ABYSSLATE_PATCH.get(), new AbysslatePatchFeature.Configuration(BlockStateProvider.simple(BlockInit.CRYOBYSSLATE.get()), BlockStateProvider.simple(BlockInit.CRYOBYSSAL_MAGMA_BLOCK.get()), BlockStateProvider.simple(BlockInit.CRYOBYSSAL_GEYSER.get())));
        register(context, LUNAR, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(BlockInit.LUNAR_LOG.get()), new BranchingTrunkPlacer(8, 2, 10, ConstantInt.of(0), UniformInt.of(4, 5), ConstantInt.of(1), UniformInt.of(3, 4)), BlockStateProvider.simple(BlockInit.LUNAR_LEAVES.get()), new SpheroidFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)), new TwoLayersFeatureSize(4, 1, 1)).decorators(List.of(new TrunkBerriesDecorator())).build());
        register(context, LUNAR_HUGE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(BlockInit.LUNAR_LOG.get()), new BranchingTrunkPlacer(32, 2, 10, UniformInt.of(3, 4), UniformInt.of(2, 4)), BlockStateProvider.simple(BlockInit.LUNAR_LEAVES.get()), new SpheroidFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0)), new TwoLayersFeatureSize(4, 1, 1)).decorators(List.of(new TrunkBerriesDecorator())).build());
        ...
        register(context, SCARLET, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(BlockInit.SCARLET_LOG.get()), new StraightTrunkPlacer(10, 2, 10), BlockStateProvider.simple(BlockInit.SCARLET_LEAVES.get()), new ScarletFoliagePlacer(UniformInt.of(2, 3), ConstantInt.of(0)), new TwoLayersFeatureSize(4, 1, 1)).decorators(List.of(new TrunkCobwebDecorator())).build());
        register(context, TORREYA, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(BlockInit.TORREYA_LOG.get()), new BranchingTrunkPlacer(32, 2, 10, UniformInt.of(3, 4), UniformInt.of(2, 4)), BlockStateProvider.simple(BlockInit.TORREYA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.PERSISTENT, true)), new TorreyaFoliagePlacer(ConstantInt.of(5), ConstantInt.of(0)), new TwoLayersFeatureSize(4, 1, 1)).decorators(List.of(new TorreyaVinesDecorator())).build());
        register(context, HUGE_GLOWING_MUSHROOM, FeatureInit.HUGE_GLOWING_MUSHROOM.get(), new HugeMushroomFeatureConfiguration(BlockStateProvider.simple(BlockInit.GLOWING_MUSHROOM_BLOCK.get().defaultBlockState()), BlockStateProvider.simple(BlockInit.GLOWING_MUSHROOM_STEM.get().defaultBlockState().setValue(HugeMushroomBlock.UP, false).setValue(HugeMushroomBlock.DOWN, false)), 3));
        ...
        register(context, SCARLET_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.SCARLET_TREE_CHECKED), 0.75F), new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.HUGE_GLOWING_MUSHROOM_CHECKED), 0.1F)), placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.SCARLET_TREE_CHECKED)));
        register(context, TORREYA_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.TORREYA_TREE_CHECKED), 0.25F)), placedFeatureHolderGetter.getOrThrow(PlacedFeatureInit.TORREYA_TREE_CHECKED)));
        register(context, DEAD_LUNAR_TREE, FeatureInit.DEAD_LUNAR_TREE.get(), new NoneFeatureConfiguration());
        register(context, FOREST_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.SMALL_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.SMALL_GLOWING_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.LUNAR_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_LUNAR_GRASS.get().defaultBlockState(), 2).add(BlockInit.CRESCENT_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_CRESCENT_GRASS.get().defaultBlockState(), 2).add(BlockInit.PARASOL_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_PARASOL_GRASS.get().defaultBlockState(), 2).add(BlockInit.LUNAR_BUSH.get().defaultBlockState(), 2).add(BlockInit.GLOWING_LUNAR_BUSH.get().defaultBlockState(), 2).add(BlockInit.TALL_CRESCENT_GRASS.get().defaultBlockState(), 1).add(BlockInit.TALL_GLOWING_CRESCENT_GRASS.get().defaultBlockState(), 1).add(BlockInit.GLADESPIKE.get().defaultBlockState(), 2).add(BlockInit.TALL_GLADESPIKE.get().defaultBlockState(), 1).add(BlockInit.VIVIDSTALK.get().defaultBlockState(), 1).add(BlockInit.PINK_ROSE.get().defaultBlockState(), 2).add(BlockInit.PINK_ROSE_BUSH.get().defaultBlockState(), 1).add(BlockInit.STARLIGHT_TORCHFLOWER.get().defaultBlockState(), 2).add(BlockInit.WHISPERBLOOM.get().defaultBlockState(), 2).add(BlockInit.STARLIGHT_FLOWER.get().defaultBlockState(), 2)), 128));
        register(context, SWAMP_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.FANTABUD.get().defaultBlockState(), 1).add(BlockInit.GREEN_FANTABUD.get().defaultBlockState(), 1).add(BlockInit.FANTAFERN.get().defaultBlockState(), 1).add(BlockInit.GREEN_FANTAFERN.get().defaultBlockState(), 1).add(BlockInit.FANTAGRASS.get().defaultBlockState(), 1).add(BlockInit.GREEN_FANTAGRASS.get().defaultBlockState(), 1).add(BlockInit.VIVIDSTALK.get().defaultBlockState(), 1).add(BlockInit.SWAMP_ROSE.get().defaultBlockState(), 1).add(BlockInit.NIGHTFAN.get().defaultBlockState(), 1).add(BlockInit.WHISPERBLOOM.get().defaultBlockState(), 1).add(BlockInit.STARLIGHT_FLOWER.get().defaultBlockState(), 1)), 128));
        register(context, PERMAFROST_FOREST_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.SMALL_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.SMALL_GLOWING_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.LUNAR_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_LUNAR_GRASS.get().defaultBlockState(), 2).add(BlockInit.CRESCENT_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_CRESCENT_GRASS.get().defaultBlockState(), 2).add(BlockInit.PARASOL_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_PARASOL_GRASS.get().defaultBlockState(), 2).add(BlockInit.LUNAR_BUSH.get().defaultBlockState(), 2).add(BlockInit.GLOWING_LUNAR_BUSH.get().defaultBlockState(), 2).add(BlockInit.TALL_CRESCENT_GRASS.get().defaultBlockState(), 1).add(BlockInit.TALL_GLOWING_CRESCENT_GRASS.get().defaultBlockState(), 1).add(BlockInit.CONEBLOOM.get().defaultBlockState(), 2).add(BlockInit.VIVIDSTALK.get().defaultBlockState(), 1).add(BlockInit.WHISPERBLOOM.get().defaultBlockState(), 2).add(BlockInit.STARLIGHT_FLOWER.get().defaultBlockState(), 2)), 128));
        register(context, SCARLET_FOREST_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.ORANGE_SCARLET_BUD.get().defaultBlockState(), 1).add(BlockInit.PURPLE_SCARLET_BUD.get().defaultBlockState(), 1).add(BlockInit.RED_SCARLET_BUD.get().defaultBlockState(), 1).add(BlockInit.SCARLET_GRASS.get().defaultBlockState(), 1).add(BlockInit.WHISPERBLOOM.get().defaultBlockState(), 1).add(BlockInit.STARLIGHT_FLOWER.get().defaultBlockState(), 1)), 128));
        register(context, TORREYA_FOREST_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.WITHERED_STARLIGHT_FLOWER.get().defaultBlockState(), 1)), 128));
        register(context, DESERT_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.DEAD_LUNAR_BUSH.get().defaultBlockState(), 1)), 5));
        register(context, NEAR_WATER_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.LUNAR_REED.get().defaultBlockState(), 1)), 128));
        register(context, ON_WATER_PLANT, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.MOONLIGHT_DUCKWEED.get().defaultBlockState(), 18).add(BlockInit.MOONLIGHT_LILY_PAD.get().defaultBlockState(), 2).add(BlockInit.STARLIT_LILY_PAD.get().defaultBlockState(), 1)), 128));
        register(context, SWAMP_WATER, FeatureInit.SWAMP_WATER.get(), new NoneFeatureConfiguration());
        register(context, HOT_SPRING, FeatureInit.LAKE.get(), new ESLakeFeature.Configuration(BlockStateProvider.simple(Blocks.WATER.defaultBlockState()), new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.SPRINGSTONE.get().defaultBlockState(), 10).add(BlockInit.THERMAL_SPRINGSTONE.get().defaultBlockState(), 1).build())));
