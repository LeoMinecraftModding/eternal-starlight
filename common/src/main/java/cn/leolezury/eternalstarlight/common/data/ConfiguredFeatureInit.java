...
public class ConfiguredFeatureInit {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, ON_WATER_PLANT, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.MOONLIGHT_DUCKWEED.get().defaultBlockState(), 8).add(BlockInit.MOONLIGHT_LILY_PAD.get().defaultBlockState(), 1)), 128));
