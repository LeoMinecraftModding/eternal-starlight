...
public class ConfiguredFeatureInit {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, FOREST_GRASS, Feature.FLOWER, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.SMALL_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.SMALL_GLOWING_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.LUNAR_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_LUNAR_GRASS.get().defaultBlockState(), 2).add(BlockInit.CRESCENT_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_CRESCENT_GRASS.get().defaultBlockState(), 2).add(BlockInit.PARASOL_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_PARASOL_GRASS.get().defaultBlockState(), 2).add(BlockInit.LUNAR_REED.get().defaultBlockState(), 1).add(BlockInit.GLADESPIKE.get().defaultBlockState(), 2).add(BlockInit.VIVIDSTALK.get().defaultBlockState(), 1).add(BlockInit.PINK_ROSE.get().defaultBlockState(), 2).add(BlockInit.STARLIGHT_TORCHFLOWER.get().defaultBlockState(), 2).add(BlockInit.STARLIGHT_FLOWER.get().defaultBlockState(), 2)), 128));
        register(context, SWAMP_GRASS, Feature.FLOWER, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.FANTABUD.get().defaultBlockState(), 1).add(BlockInit.GREEN_FANTABUD.get().defaultBlockState(), 1).add(BlockInit.FANTAFERN.get().defaultBlockState(), 1).add(BlockInit.GREEN_FANTAFERN.get().defaultBlockState(), 1).add(BlockInit.FANTAGRASS.get().defaultBlockState(), 1).add(BlockInit.GREEN_FANTAGRASS.get().defaultBlockState(), 1).add(BlockInit.VIVIDSTALK.get().defaultBlockState(), 1).add(BlockInit.SWAMP_ROSE.get().defaultBlockState(), 1).add(BlockInit.NIGHTFAN.get().defaultBlockState(), 1).add(BlockInit.STARLIGHT_FLOWER.get().defaultBlockState(), 1)), 128));
        register(context, PERMAFROST_FOREST_GRASS, Feature.FLOWER, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.SMALL_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.SMALL_GLOWING_NIGHT_SPROUTS.get().defaultBlockState(), 2).add(BlockInit.LUNAR_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_LUNAR_GRASS.get().defaultBlockState(), 2).add(BlockInit.CRESCENT_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_CRESCENT_GRASS.get().defaultBlockState(), 2).add(BlockInit.PARASOL_GRASS.get().defaultBlockState(), 2).add(BlockInit.GLOWING_PARASOL_GRASS.get().defaultBlockState(), 2).add(BlockInit.LUNAR_REED.get().defaultBlockState(), 1).add(BlockInit.CONEBLOOM.get().defaultBlockState(), 2).add(BlockInit.VIVIDSTALK.get().defaultBlockState(), 1).add(BlockInit.STARLIGHT_FLOWER.get().defaultBlockState(), 2)), 128));
        register(context, SCARLET_FOREST_GRASS, Feature.FLOWER, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(BlockInit.ORANGE_SCARLET_BUD.get().defaultBlockState(), 1).add(BlockInit.PURPLE_SCARLET_BUD.get().defaultBlockState(), 1).add(BlockInit.RED_SCARLET_BUD.get().defaultBlockState(), 1).add(BlockInit.SCARLET_GRASS.get().defaultBlockState(), 1).add(BlockInit.STARLIGHT_FLOWER.get().defaultBlockState(), 1)), 128));
