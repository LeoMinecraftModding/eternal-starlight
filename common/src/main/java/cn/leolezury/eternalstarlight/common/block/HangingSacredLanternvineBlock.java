...
public class HangingSacredLanternvineBlock extends GrowingPlantHeadBlock {
	public static final MapCodec<HangingSacredLanternvineBlock> CODEC = simpleCodec(HangingSacredLanternvineBlock::new);
	...
	@Override
	protected MapCodec<HangingSacredLanternvineBlock> codec() {
		return CODEC;
	}
