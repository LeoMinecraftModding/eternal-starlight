...
public class BiomeDataRegistry {
    ...
    public static final int DARK_SWAMP = register(new BiomeData.Builder(new ResourceLocation(EternalStarlight.MOD_ID, "dark_swamp"), 60, 5).withTemperatures(BiomeData.Temperature.NEUTRAL, BiomeData.Temperature.HOT).build());
    ...
    public static final int SCARLET_FOREST = register(new BiomeData.Builder(new ResourceLocation(EternalStarlight.MOD_ID, "scarlet_forest"), 70, 15).withTemperatures(BiomeData.Temperature.NEUTRAL, BiomeData.Temperature.HOT).build());
