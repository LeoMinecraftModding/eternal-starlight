...
public class ESAttributes {
	...
	public static final RegistryObject<Attribute, Attribute> FIRE_RESISTANCE = ATTRIBUTES.register("generic.fire_resistance", () -> new RangedAttribute("attribute.name." + EternalStarlight.ID + ".generic.fire_resistance", 0, 0, 1).setSyncable(true));
	public static final RegistryObject<Attribute, RangedAttribute> COLD_RESISTANCE = ATTRIBUTES.register("generic.cold_resistance", () -> new RangedAttribute("attribute.name." + EternalStarlight.ID + ".generic.cold_resistance", 0, 0, 1));
