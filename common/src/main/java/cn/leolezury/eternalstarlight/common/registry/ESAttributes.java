...
public class ESAttributes {
	...
	public static final RegistryObject<Attribute, RangedAttribute> THROWN_POTION_DISTANCE = ATTRIBUTES.register("generic.thrown_potion_distance", () -> new RangedAttribute("attribute.name." + EternalStarlight.ID + ".generic.thrown_potion_distance", 1, 0, 5));
