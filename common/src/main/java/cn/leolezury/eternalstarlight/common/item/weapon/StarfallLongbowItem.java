...
public class StarfallLongbowItem extends BowItem {
    ...
    public void releaseUsing(ItemStack stack, Level level, LivingEntity entity, int n) {
        if (entity instanceof Player player) {
            ...
            i = ESPlatform.INSTANCE.postArrowLooseEvent(stack, level, player, i, !itemstack.isEmpty() || flag);
            if (i < 0) return;
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    boolean flag1 = player.getAbilities().instabuild || (itemstack.getItem() instanceof ArrowItem && ESPlatform.INSTANCE.isArrowInfinite(itemstack, stack, player));
