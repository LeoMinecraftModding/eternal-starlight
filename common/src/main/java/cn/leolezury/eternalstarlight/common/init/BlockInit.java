...
public class BlockInit {
    ...
    public static final RegistryObject<Block, Block> TORREYA_SAPLING = BLOCKS.register("torreya_sapling", () -> new SaplingBlock(new TreeGrower("torreya", Optional.empty(), Optional.of(ConfiguredFeatureInit.TORREYA), Optional.empty()), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SAPLING).mapColor(MapColor.COLOR_RED)));
    ...
    public static final RegistryObject<Block, Block> GLOWING_MUSHROOM = BLOCKS.register("glowing_mushroom", () -> new MushroomBlock(ConfiguredFeatureInit.HUGE_GLOWING_MUSHROOM, BlockBehaviour.Properties.ofFullCopy(Blocks.RED_MUSHROOM).mapColor(MapColor.COLOR_LIGHT_BLUE).lightLevel((state) -> 15)));
    ...
    public static final RegistryObject<Block, TerraStatueBlock> TERRA_STATUE = BLOCKS.register("terra_statue", () -> new TerraStatueBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OBSIDIAN)));
