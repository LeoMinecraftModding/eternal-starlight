...
public class BoarwarfDruidLayer extends RenderLayer<BoarwarfRenderState, BoarwarfModel> {
	private static final ResourceLocation TEXTURE = EternalStarlight.id("textures/entity/boarwarf/profession/druid.png");
	private final BoarwarfDruidModel professionModel;

	public BoarwarfDruidLayer(RenderLayerParent<BoarwarfRenderState, BoarwarfModel> parent, EntityModelSet modelSet) {
		super(parent);
	...
	public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, BoarwarfRenderState state, float netHeadYaw, float headPitch) {
		if (!state.isInvisible && state.profession == ESBoarwarfProfessions.DRUID.get()) {
