...
public class ESConfiguredFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		FeatureUtils.register(context, ICE_SPIKE, ESFeatures.ICE_SPIKE.get());
		...
		FeatureUtils.register(context, LUNAR_SMALL, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(ESBlocks.LUNAR_LOG.get()), new StraightTrunkPlacer(2, 1, 1), BlockStateProvider.simple(ESBlocks.LUNAR_LEAVES.get().defaultBlockState().setValue(LeavesBlock.PERSISTENT, true)), new SpheroidFoliagePlacer(ConstantInt.of(7), ConstantInt.of(0)), new TwoLayersFeatureSize(1, 0, 1)).dirt(BlockStateProvider.simple(ESBlocks.NIGHTFALL_DIRT.get())).build());
		...
		FeatureUtils.register(context, SCRUBLAND_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatures.getOrThrow(ESPlacedFeatures.LUNAR_SMALL_TREE_CHECKED), 0.9F), new WeightedPlacedFeature(placedFeatures.getOrThrow(ESPlacedFeatures.LUNAR_TREE_CHECKED), 0.07F), new WeightedPlacedFeature(placedFeatures.getOrThrow(ESPlacedFeatures.HUGE_GLOWING_MUSHROOM_CHECKED), 0.03F)), placedFeatures.getOrThrow(ESPlacedFeatures.LUNAR_SMALL_TREE_CHECKED)));
