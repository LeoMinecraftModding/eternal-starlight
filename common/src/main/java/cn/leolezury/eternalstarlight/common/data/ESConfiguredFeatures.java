...
public class ESConfiguredFeatures {
	...
	public static final ResourceKey<ConfiguredFeature<?, ?>> GRIMSTONE_MALARITE_ORE = create("grimstone_malarite_ore");
	public static final ResourceKey<ConfiguredFeature<?, ?>> VOIDSTONE_MALARITE_ORE = create("voidstone_malarite_ore");
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		FeatureUtils.register(context, GRIMSTONE_MALARITE_ORE, Feature.ORE, new OreConfiguration(grimstone, ESBlocks.GRIMSTONE_MALARITE_ORE.get().defaultBlockState(), 5));
		FeatureUtils.register(context, VOIDSTONE_MALARITE_ORE, Feature.ORE, new OreConfiguration(voidstone, ESBlocks.VOIDSTONE_MALARITE_ORE.get().defaultBlockState(), 5));
