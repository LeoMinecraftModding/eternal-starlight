...
public class ESConfiguredFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		FeatureUtils.register(context, MALARITE_ORE, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(nightfallMud, ESBlocks.NIGHTFALL_MUD_MALARITE_ORE.get().defaultBlockState()), OreConfiguration.target(grimstone, ESBlocks.GRIMSTONE_MALARITE_ORE.get().defaultBlockState()), OreConfiguration.target(voidstone, ESBlocks.VOIDSTONE_MALARITE_ORE.get().defaultBlockState())), 8));
