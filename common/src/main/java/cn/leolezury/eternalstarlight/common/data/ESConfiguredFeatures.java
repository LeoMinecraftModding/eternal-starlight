...
public class ESConfiguredFeatures {
	...
	public static final ResourceKey<ConfiguredFeature<?, ?>> ATALPHAITE_ORE = create("atalphaite_ore");
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		FeatureUtils.register(context, STONE_SPIKE, ESFeatures.STONE_SPIKE.get());
		...
		FeatureUtils.register(context, STARLIT_DIAMOND_ORE, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(grimstone, ESBlocks.GRIMSTONE_STARLIT_DIAMOND_ORE.get().defaultBlockState()), OreConfiguration.target(voidstone, ESBlocks.VOIDSTONE_STARLIT_DIAMOND_ORE.get().defaultBlockState())), 6, 0.5F));
		...
		FeatureUtils.register(context, MALARITE_ORE, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(grimstone, ESBlocks.GRIMSTONE_MALARITE_ORE.get().defaultBlockState()), OreConfiguration.target(voidstone, ESBlocks.VOIDSTONE_MALARITE_ORE.get().defaultBlockState())), 5));
		...
		FeatureUtils.register(context, ATALPHAITE_ORE, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(grimstone, ESBlocks.GRIMSTONE_ATALPHAITE_ORE.get().defaultBlockState()), OreConfiguration.target(voidstone, ESBlocks.VOIDSTONE_ATALPHAITE_ORE.get().defaultBlockState()), OreConfiguration.target(eternalIce, ESBlocks.ETERNAL_ICE_ATALPHAITE_ORE.get().defaultBlockState()), OreConfiguration.target(hazeIce, ESBlocks.HAZE_ICE_ATALPHAITE_ORE.get().defaultBlockState())), 5));
		...
		FeatureUtils.register(context, LUSH_SHALLOW_SEA_VEGETATION, ESFeatures.UNDERWATER_SIMPLE_BLOCK.get(), new SimpleBlockConfiguration(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(ESBlocks.CIRCULUSH.get().defaultBlockState(), 2).add(ESBlocks.MARIMOLD.get().defaultBlockState(), 1).add(ESBlocks.STONETT.get().defaultBlockState(), 2).add(ESBlocks.LUMINIS.get().defaultBlockState(), 2).add(ESBlocks.GLOWLIS.get().defaultBlockState(), 2).add(ESBlocks.GLOREED.get().defaultBlockState(), 3).add(ESBlocks.STARLIGHT_SEAGRASS.get().defaultBlockState(), 5))));
		...
		FeatureUtils.register(context, JINGLESTEM, ESFeatures.JINGLESTEM.get());
		...
		FeatureUtils.register(context, SWAMP_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatures.getOrThrow(ESPlacedFeatures.STARLIGHT_MANGROVE_TREE_CHECKED), 0.9F), new WeightedPlacedFeature(placedFeatures.getOrThrow(ESPlacedFeatures.HUGE_GLOWING_MUSHROOM_CHECKED), 0.1F)), placedFeatures.getOrThrow(ESPlacedFeatures.STARLIGHT_MANGROVE_TREE_CHECKED)));
		...
		FeatureUtils.register(context, TORREYA_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatures.getOrThrow(ESPlacedFeatures.TORREYA_TREE_CHECKED), 0.25F)), placedFeatures.getOrThrow(ESPlacedFeatures.TORREYA_TREE_CHECKED)));
		FeatureUtils.register(context, JINGLESTEM_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatures.getOrThrow(ESPlacedFeatures.JINGLESTEM_CHECKED), 0.25F)), placedFeatures.getOrThrow(ESPlacedFeatures.JINGLESTEM_CHECKED)));
		...
		// structure features
		FeatureUtils.register(context, GOLEM_FORGE_CHIMNEY, ESFeatures.GOLEM_FORGE_CHIMNEY.get());
	}
