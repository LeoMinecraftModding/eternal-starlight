...
public class ESConfiguredFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		FeatureUtils.register(context, ICE_SPIKE, ESFeatures.SPIKE.get(), new SpikeFeature.Configuration(BlockStateProvider.simple(Blocks.PACKED_ICE), UniformInt.of(25, 35), UniformInt.of(4, 7), UniformInt.of(1, 4), UniformInt.of(10, 15), UniformInt.of(4, 7)));
