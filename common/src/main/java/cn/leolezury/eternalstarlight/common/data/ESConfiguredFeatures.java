...
import cn.leolezury.eternalstarlight.common.init.ESFeatures;
...
public class ESConfiguredFeatures {
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, ETHER_FLUID_BORDER, ESFeatures.ETHER_FLUID_BORDER.get(), new NoneFeatureConfiguration());
        register(context, STONE_SPIKE, ESFeatures.STONE_SPIKE.get(), new NoneFeatureConfiguration());
        ...
        register(context, GLOWING_GRIMSTONE_ORE, Feature.ORE, new OreConfiguration(grimstoneRule, ESBlocks.GLOWING_GRIMSTONE.get().defaultBlockState(), 20));
        register(context, GLOWING_VOIDSTONE_ORE, Feature.ORE, new OreConfiguration(voidstoneRule, ESBlocks.GLOWING_VOIDSTONE.get().defaultBlockState(), 20));
        register(context, GLOWING_NIGHTSHADE_MUD_ORE, Feature.ORE, new OreConfiguration(mudRule, ESBlocks.GLOWING_NIGHTSHADE_MUD.get().defaultBlockState(), 20));
        register(context, NIGHTSHADE_DIRT_ORE, Feature.ORE, new OreConfiguration(slRule, ESBlocks.NIGHTSHADE_DIRT.get().defaultBlockState(), 33));
        register(context, SWAMP_SILVER_ORE, Feature.ORE, new OreConfiguration(mudRule, ESBlocks.SWAMP_SILVER_ORE.get().defaultBlockState(), 7));
        register(context, GRIMSTONE_REDSTONE_ORE, Feature.ORE, new OreConfiguration(grimstoneRule, ESBlocks.GRIMSTONE_REDSTONE_ORE.get().defaultBlockState(), 7));
        register(context, VOIDSTONE_REDSTONE_ORE, Feature.ORE, new OreConfiguration(voidstoneRule, ESBlocks.VOIDSTONE_REDSTONE_ORE.get().defaultBlockState(), 7));
        register(context, GRIMSTONE_SALTPETER_ORE, Feature.ORE, new OreConfiguration(grimstoneRule, ESBlocks.GRIMSTONE_SALTPETER_ORE.get().defaultBlockState(), 20));
        register(context, VOIDSTONE_SALTPETER_ORE, Feature.ORE, new OreConfiguration(voidstoneRule, ESBlocks.VOIDSTONE_SALTPETER_ORE.get().defaultBlockState(), 20));
        register(context, FALLEN_LUNAR_LOG, ESFeatures.FALLEN_LOG.get(), new FallenLogFeature.Configuration(BlockStateProvider.simple(ESBlocks.LUNAR_LOG.get())));
        register(context, FALLEN_NORTHLAND_LOG, ESFeatures.FALLEN_LOG.get(), new FallenLogFeature.Configuration(BlockStateProvider.simple(ESBlocks.NORTHLAND_LOG.get())));
        register(context, FALLEN_STARLIGHT_MANGROVE_LOG, ESFeatures.FALLEN_LOG.get(), new FallenLogFeature.Configuration(BlockStateProvider.simple(ESBlocks.STARLIGHT_MANGROVE_LOG.get())));
        register(context, FALLEN_SCARLET_LOG, ESFeatures.FALLEN_LOG.get(), new FallenLogFeature.Configuration(BlockStateProvider.simple(ESBlocks.SCARLET_LOG.get())));
        register(context, SCARLET_LEAVES_PILE, ESFeatures.LEAVES_PILE.get(), new LeavesPileFeature.Configuration(BlockStateProvider.simple(ESBlocks.SCARLET_LEAVES_PILE.get())));
        register(context, STARLIGHT_CRYSTAL, ESFeatures.STARLIGHT_CRYSTAL.get(), new NoneFeatureConfiguration());
        ...
        register(context, ABYSSAL_KELP, ESFeatures.KELP.get(), new NoneFeatureConfiguration());
        ...
        register(context, ABYSSLATE_PATCH, ESFeatures.ABYSSLATE_PATCH.get(), new AbysslatePatchFeature.Configuration(BlockStateProvider.simple(ESBlocks.ABYSSLATE.get()), BlockStateProvider.simple(ESBlocks.ABYSSAL_MAGMA_BLOCK.get()), BlockStateProvider.simple(ESBlocks.ABYSSAL_GEYSER.get())));
        register(context, THERMABYSSLATE_PATCH, ESFeatures.ABYSSLATE_PATCH.get(), new AbysslatePatchFeature.Configuration(BlockStateProvider.simple(ESBlocks.THERMABYSSLATE.get()), BlockStateProvider.simple(ESBlocks.THERMABYSSAL_MAGMA_BLOCK.get()), BlockStateProvider.simple(ESBlocks.THERMABYSSAL_GEYSER.get())));
        register(context, CRYOBYSSLATE_PATCH, ESFeatures.ABYSSLATE_PATCH.get(), new AbysslatePatchFeature.Configuration(BlockStateProvider.simple(ESBlocks.CRYOBYSSLATE.get()), BlockStateProvider.simple(ESBlocks.CRYOBYSSAL_MAGMA_BLOCK.get()), BlockStateProvider.simple(ESBlocks.CRYOBYSSAL_GEYSER.get())));
        ...
        register(context, TORREYA_FOREST, Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(List.of(new WeightedPlacedFeature(placedFeatureHolderGetter.getOrThrow(ESPlacedFeatures.TORREYA_TREE_CHECKED), 0.25F)), placedFeatureHolderGetter.getOrThrow(ESPlacedFeatures.TORREYA_TREE_CHECKED)));
        register(context, DEAD_LUNAR_TREE, ESFeatures.DEAD_LUNAR_TREE.get(), new NoneFeatureConfiguration());
        ...
        register(context, TORREYA_FOREST_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(ESBlocks.WITHERED_STARLIGHT_FLOWER.get().defaultBlockState(), 1)), 128));
        register(context, DESERT_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(ESBlocks.DEAD_LUNAR_BUSH.get().defaultBlockState(), 1)), 5));
        register(context, NEAR_WATER_GRASS, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(ESBlocks.LUNAR_REED.get().defaultBlockState(), 1)), 128));
        ...
        register(context, SWAMP_WATER, ESFeatures.SWAMP_WATER.get(), new NoneFeatureConfiguration());
