...
public class ESConfiguredFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		FeatureUtils.register(context, DEEPSILVER_ORE, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(grimstone, ESBlocks.GRIMSTONE_DEEPSILVER_ORE.get().defaultBlockState()), OreConfiguration.target(voidstone, ESBlocks.VOIDSTONE_DEEPSILVER_ORE.get().defaultBlockState()), OreConfiguration.target(eternalIce, ESBlocks.ETERNAL_ICE_DEEPSILVER_ORE.get().defaultBlockState()), OreConfiguration.target(hazeIce, ESBlocks.HAZE_ICE_DEEPSILVER_ORE.get().defaultBlockState())), 10));
		FeatureUtils.register(context, MALARITE_ORE, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(nightfallMud, ESBlocks.NIGHTFALL_MUD_MALARITE_ORE.get().defaultBlockState()), OreConfiguration.target(grimstone, ESBlocks.GRIMSTONE_MALARITE_ORE.get().defaultBlockState()), OreConfiguration.target(voidstone, ESBlocks.VOIDSTONE_MALARITE_ORE.get().defaultBlockState())), 10));
