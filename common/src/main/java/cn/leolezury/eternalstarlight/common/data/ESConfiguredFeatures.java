...
public class ESConfiguredFeatures {
	...
	public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		FeatureUtils.register(context, GLOWING_NIGHTFALL_MUD_ORE, Feature.ORE, new OreConfiguration(mudRule, ESBlocks.GLOWING_NIGHTFALL_MUD.get().defaultBlockState(), 20));
		FeatureUtils.register(context, NIGHTFALL_DIRT_ORE, Feature.ORE, new OreConfiguration(slRule, ESBlocks.NIGHTFALL_DIRT.get().defaultBlockState(), 33));
		...
		FeatureUtils.register(context, SCARLET_FOREST_VEGETATION, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(ESBlocks.ORANGE_SCARLET_BUD.get().defaultBlockState(), 1).add(ESBlocks.PURPLE_SCARLET_BUD.get().defaultBlockState(), 1).add(ESBlocks.RED_SCARLET_BUD.get().defaultBlockState(), 1).add(ESBlocks.SCARLET_GRASS.get().defaultBlockState(), 1).add(ESBlocks.MAUVE_FERN.get().defaultBlockState(), 1).add(ESBlocks.WHISPERBLOOM.get().defaultBlockState(), 1).add(ESBlocks.STARLIGHT_FLOWER.get().defaultBlockState(), 1)), 128));
		FeatureUtils.register(context, TORREYA_FOREST_VEGETATION, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(ESBlocks.WITHERED_STARLIGHT_FLOWER.get().defaultBlockState(), 1).add(ESBlocks.MAUVE_FERN.get().defaultBlockState(), 1)), 128));
		FeatureUtils.register(context, DESERT_VEGETATION, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(ESBlocks.DEAD_LUNAR_BUSH.get().defaultBlockState(), 3).add(ESBlocks.DESERT_AMETHYSIA.get().defaultBlockState(), 1).add(ESBlocks.WITHERED_DESERT_AMETHYSIA.get().defaultBlockState(), 1).add(ESBlocks.SUNSET_THORNBLOOM.get().defaultBlockState(), 1).add(ESBlocks.AMETHYSIA_GRASS.get().defaultBlockState(), 30).add(ESBlocks.MAUVE_FERN.get().defaultBlockState(), 27)), 64));
		FeatureUtils.register(context, WATERSIDE_VEGETATION, Feature.RANDOM_PATCH, grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(ESBlocks.LUNAR_REED.get().defaultBlockState(), 1)), 128));
