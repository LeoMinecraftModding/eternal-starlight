...
public class CrestInit {
    ...
    public static void bootstrap(BootstapContext<Crest> context) {
        ...
        context.register(GUIDANCE_OF_STARS, new Crest(ManaType.LUNAR, new ResourceLocation(EternalStarlight.MOD_ID, "textures/crest/guidance_of_stars.png"), SpellInit.GUIDANCE_OF_STARS.get()));
    }
