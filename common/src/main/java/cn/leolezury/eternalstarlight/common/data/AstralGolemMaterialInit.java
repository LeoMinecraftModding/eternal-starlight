...
public class AstralGolemMaterialInit {
    ...
    public static void bootstrap(BootstapContext<AstralGolemMaterial> context) {
        ...
        context.register(SWAMP_SILVER, new AstralGolemMaterial(ItemInit.SWAMP_SILVER_INGOT.get(), 1.2f, 1.2f, new ResourceLocation(EternalStarlight.MOD_ID, "textures/entity/boarwarf/golem/astral_golem_swamp_silver.png"), 0xffffff));
    }
