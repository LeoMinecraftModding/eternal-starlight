...
public class ESBlocks {
	...
	public static final RegistryObject<Block, ESShortBushBlock> MOONLIGHT_BUSH = BLOCKS.register("moonlight_bush", () -> new MoonlightBushBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_BLUE).lightLevel(state -> 10)));
