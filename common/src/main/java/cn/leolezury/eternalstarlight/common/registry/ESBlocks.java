...
public class ESBlocks {
	...
	public static final RegistryObject<Block, DropExperienceBlock> NIGHTFALL_MUD_DEEPSILVER_ORE = BLOCKS.register("nightfall_mud_deepsilver_ore", () -> new DropExperienceBlock(UniformInt.of(0, 2), BlockBehaviour.Properties.ofFullCopy(Blocks.MUD).strength(3.0F)));
	public static final RegistryObject<Block, DropExperienceBlock> PACKED_NIGHTFALL_MUD_DEEPSILVER_ORE = BLOCKS.register("packed_nightfall_mud_deepsilver_ore", () -> new DropExperienceBlock(UniformInt.of(0, 2), BlockBehaviour.Properties.ofFullCopy(Blocks.PACKED_MUD).strength(4.0F)));
	...
	public static final RegistryObject<Block, DropExperienceBlock> PACKED_NIGHTFALL_MUD_MALARITE_ORE = BLOCKS.register("packed_nightfall_mud_malarite_ore", () -> new DropExperienceBlock(UniformInt.of(0, 2), BlockBehaviour.Properties.ofFullCopy(Blocks.PACKED_MUD).strength(4.0F)));
	...
	public static final RegistryObject<Block, EnergyTransmitterBlock> ENERGY_TRANSMITTER = BLOCKS.register("energy_transmitter", () -> new EnergyTransmitterBlock(BlockBehaviour.Properties.of().instabreak().lightLevel(state -> state.getValue(EnergyTransmitterBlock.POWERED) ? 15 : 0).sound(SoundType.STONE).pushReaction(PushReaction.DESTROY)));
