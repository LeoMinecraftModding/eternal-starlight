...
public class ESBlocks {
	...
	public static final RegistryObject<Block, TransparentBlock> MARIMOLD_BLOCK = BLOCKS.register("marimold_block", () -> new TransparentBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_MUSHROOM_BLOCK).mapColor(MapColor.COLOR_YELLOW).noOcclusion().lightLevel(state -> 12)));
	public static final RegistryObject<Block, HugeMushroomBlock> MARIMOLD_STEM = BLOCKS.register("marimold_stem", () -> new HugeMushroomBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.MUSHROOM_STEM).mapColor(MapColor.COLOR_PURPLE)));
	...
	public static final RegistryObject<Block, Block> CRACKED_VOIDSTONE_BRICKS = BLOCKS.register("cracked_voidstone_bricks", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CRACKED_STONE_BRICKS).mapColor(MapColor.COLOR_BLACK)));
	...
	public static final RegistryObject<Block, Block> CRACKED_VOIDSTONE_TILES = BLOCKS.register("cracked_voidstone_tiles", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.CRACKED_STONE_BRICKS).mapColor(MapColor.COLOR_BLACK)));
	...
	public static final RegistryObject<Block, DuskEmitterBlock> DUSK_EMITTER = BLOCKS.register("dusk_emitter", () -> new DuskEmitterBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).strength(50.0F, 1200.0F).mapColor(MapColor.COLOR_ORANGE).lightLevel(state -> 15)));
	...
	public static final RegistryObject<Block, WeatheringGolemSteelFullBlock> WAXED_GOLEM_STEEL_BLOCK = BLOCKS.register("waxed_golem_steel_block", () -> new WeatheringGolemSteelFullBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WAXED_COPPER_BLOCK).mapColor(MapColor.COLOR_BLUE)));
	...
	public static final RegistryObject<Block, WeatheringGolemSteelSlabBlock> WAXED_GOLEM_STEEL_SLAB = BLOCKS.register("waxed_golem_steel_slab", () -> new WeatheringGolemSteelSlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WAXED_CUT_COPPER_SLAB).mapColor(MapColor.COLOR_BLUE)));
	...
	public static final RegistryObject<Block, WeatheringGolemSteelFullBlock> WAXED_GOLEM_STEEL_TILES = BLOCKS.register("waxed_golem_steel_tiles", () -> new WeatheringGolemSteelFullBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WAXED_COPPER_BLOCK).mapColor(MapColor.COLOR_BLUE)));
	...
	public static final RegistryObject<Block, WeatheringGolemSteelSlabBlock> WAXED_GOLEM_STEEL_TILE_SLAB = BLOCKS.register("waxed_golem_steel_tile_slab", () -> new WeatheringGolemSteelSlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WAXED_CUT_COPPER_SLAB).mapColor(MapColor.COLOR_BLUE)));
	...
	public static final RegistryObject<Block, WeatheringGolemSteelGrateBlock> WAXED_GOLEM_STEEL_GRATE = BLOCKS.register("waxed_golem_steel_grate", () -> new WeatheringGolemSteelGrateBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WAXED_COPPER_GRATE).mapColor(MapColor.COLOR_BLUE)));
	...
	public static final RegistryObject<Block, WeatheringGolemSteelPillarBlock> WAXED_GOLEM_STEEL_PILLAR = BLOCKS.register("waxed_golem_steel_pillar", () -> new WeatheringGolemSteelPillarBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WAXED_COPPER_BLOCK).mapColor(MapColor.COLOR_LIGHT_BLUE).lightLevel(state -> 10)));
	...
	public static final RegistryObject<Block, WeatheringGolemSteelBarsBlock> WAXED_GOLEM_STEEL_BARS = BLOCKS.register("waxed_golem_steel_bars", () -> new WeatheringGolemSteelBarsBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BARS).mapColor(MapColor.COLOR_BLUE)));
	...
	public static final RegistryObject<Block, WeatheringGolemSteelFullBlock> WAXED_CHISELED_GOLEM_STEEL_BLOCK = BLOCKS.register("waxed_chiseled_golem_steel_block", () -> new WeatheringGolemSteelFullBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WAXED_COPPER_BLOCK).mapColor(MapColor.COLOR_BLUE)));
	...
	public static final RegistryObject<Block, ESShortBushBlock> MOONLIGHT_BUSH = BLOCKS.register("moonlight_bush", () -> new MoonlightBushBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.FERN).mapColor(MapColor.COLOR_BLUE).randomTicks().lightLevel(state -> state.getValue(MoonlightBushBlock.BERRIES) ? 15 : 0)));
	...
	public static final RegistryObject<Block, HugeMushroomBlock> GLOWING_MUSHROOM_BLOCK = BLOCKS.register("glowing_mushroom_block", () -> new HugeMushroomBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.RED_MUSHROOM_BLOCK).mapColor(MapColor.COLOR_LIGHT_BLUE).lightLevel(state -> 15)));
	...
	public static final RegistryObject<Block, Block> ETERNAL_ICE_STARLIT_DIAMOND_ORE = BLOCKS.register("eternal_ice_starlit_diamond_ore", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.DIAMOND_ORE).mapColor(MapColor.ICE).sound(SoundType.GLASS)));
	public static final RegistryObject<Block, Block> HAZE_ICE_STARLIT_DIAMOND_ORE = BLOCKS.register("haze_ice_starlit_diamond_ore", () -> new Block(BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE_DIAMOND_ORE).mapColor(MapColor.ICE).sound(SoundType.GLASS)));
