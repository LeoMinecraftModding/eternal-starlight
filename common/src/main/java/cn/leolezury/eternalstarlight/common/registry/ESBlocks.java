...
public class ESBlocks {
	...
	public static final RegistryObject<Block, StarfireBirdAviaryBlock> LUNAR_STARFIRE_BIRD_AVIARY = BLOCKS.register("lunar_starfire_bird_aviary", () -> new StarfireBirdAviaryBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BEEHIVE).mapColor(MapColor.COLOR_BLACK).noOcclusion()));
	public static final RegistryObject<Block, StarfireBirdAviaryBlock> NORTHLAND_STARFIRE_BIRD_AVIARY = BLOCKS.register("northland_starfire_bird_aviary", () -> new StarfireBirdAviaryBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BEEHIVE).mapColor(MapColor.COLOR_BROWN).noOcclusion()));
	public static final RegistryObject<Block, StarfireBirdAviaryBlock> STARLIGHT_MANGROVE_STARFIRE_BIRD_AVIARY = BLOCKS.register("starlight_mangrove_starfire_bird_aviary", () -> new StarfireBirdAviaryBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BEEHIVE).mapColor(MapColor.COLOR_RED).noOcclusion()));
	public static final RegistryObject<Block, StarfireBirdAviaryBlock> SCARLET_STARFIRE_BIRD_AVIARY = BLOCKS.register("scarlet_starfire_bird_aviary", () -> new StarfireBirdAviaryBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BEEHIVE).mapColor(MapColor.COLOR_RED).noOcclusion()));
	public static final RegistryObject<Block, StarfireBirdAviaryBlock> TORREYA_STARFIRE_BIRD_AVIARY = BLOCKS.register("torreya_starfire_bird_aviary", () -> new StarfireBirdAviaryBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BEEHIVE).mapColor(MapColor.COLOR_BLACK).noOcclusion()));
	public static final RegistryObject<Block, StarfireBirdAviaryBlock> JINGLESTEM_STARFIRE_BIRD_AVIARY = BLOCKS.register("jinglestem_starfire_bird_aviary", () -> new StarfireBirdAviaryBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BEEHIVE).mapColor(MapColor.COLOR_GREEN).noOcclusion()));
