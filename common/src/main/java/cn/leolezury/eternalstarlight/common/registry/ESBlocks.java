...
public class ESBlocks {
	...
	public static final RegistryObject<Block, DropExperienceBlock> NIGHTFALL_MUD_DEEPSILVER_ORE = BLOCKS.register("nightfall_mud_deepsilver_ore", () -> new DropExperienceBlock(UniformInt.of(0, 2), BlockBehaviour.Properties.ofFullCopy(Blocks.MUD).strength(3.0F).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block, DropExperienceBlock> PACKED_NIGHTFALL_MUD_DEEPSILVER_ORE = BLOCKS.register("packed_nightfall_mud_deepsilver_ore", () -> new DropExperienceBlock(UniformInt.of(0, 2), BlockBehaviour.Properties.ofFullCopy(Blocks.PACKED_MUD).strength(4.0F).requiresCorrectToolForDrops()));
