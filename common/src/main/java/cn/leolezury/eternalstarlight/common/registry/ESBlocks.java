...
public class ESBlocks {
	...
	public static final RegistryObject<Block, StellagmiteBlock> MOLTEN_STELLAGMITE = BLOCKS.register("molten_stellagmite", () -> new StellagmiteBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE).lightLevel(state -> 12)));
	public static final RegistryObject<Block, StellagmiteSlabBlock> MOLTEN_STELLAGMITE_SLAB = BLOCKS.register("molten_stellagmite_slab", () -> new StellagmiteSlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_SLAB).lightLevel(state -> 12)));
	public static final RegistryObject<Block, StellagmiteStairBlock> MOLTEN_STELLAGMITE_STAIRS = BLOCKS.register("molten_stellagmite_stairs", () -> new StellagmiteStairBlock(MOLTEN_STELLAGMITE.get().defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_STAIRS).lightLevel(state -> 12)));
	public static final RegistryObject<Block, StellagmiteWallBlock> MOLTEN_STELLAGMITE_WALL = BLOCKS.register("molten_stellagmite_wall", () -> new StellagmiteWallBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.STONE_BRICK_WALL).lightLevel(state -> 12)));
	...
	public static final RegistryObject<Block, LiquidBlock> ETHER = BLOCKS.register("ether", () -> new LiquidBlock(ESFluids.ETHER_STILL.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.LAVA).mapColor(MapColor.COLOR_LIGHT_GREEN)));
	public static final RegistryObject<Block, CrestPotBlock> CREST_POT = BLOCKS.register("crest_pot", () -> new CrestPotBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.DECORATED_POT).lightLevel(state -> 2)));
