...
public class ESBlocks {
	...
	public static final RegistryObject<Block, AlloyFurnaceBlock> ALLOY_FURNACE = BLOCKS.register("alloy_furnace", () -> new AlloyFurnaceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK).strength(4.0F, 1200.0F).mapColor(MapColor.COLOR_BLUE)));
