...
import cn.leolezury.eternalstarlight.client.model.SporeModel;
...
public class SporeRenderer extends EntityRenderer<Spore> {
    ...
    @Override
    public void render(Spore p_114485_, float p_114486_, float p_114487_, PoseStack p_114488_, MultiBufferSource p_114489_, int p_114490_) {
    ...
    @Override
    public ResourceLocation getTextureLocation(Spore entity) {
