...
public class StructurePlacementTypeInit {
    ...
    public static final RegistryObject<StructurePlacementType<ESRandomSpreadStructurePlacement>> SL_RANDOM_SPREAD = STRUCTURE_PLACEMENT_TYPES.register("es_random_spread", () -> () -> ESRandomSpreadStructurePlacement.CODEC);
